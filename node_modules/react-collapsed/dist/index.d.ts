...
declare function useCollapse({ duration, easing, onTransitionStateChange: propOnTransitionStateChange, isExpanded: configIsExpanded, defaultExpanded, hasDisabledAnimation, ...initialConfig }?: UseCollapseInput): {
    isExpanded: boolean;
    ...
    }, RefKey extends string | undefined = "ref">(rest?: (Args & {
        /**
    ...
    }, RefKey_1 extends string | undefined = "ref">(rest?: (Args_1 & {
        /**
         * Sets the key of the prop that the component uses for ref assignment
         * @default 'ref'
         */
